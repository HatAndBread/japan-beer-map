...
export default class extends Controller {
  ...
  async nearestBeer() {
    ...
    console.log(closest)
    this.map.flyTo({center: {lng: parseFloat(closest.lng), lat: parseFloat(closest.lat)}, zoom: 14})
  }
  ...
  updateUserLocation() {
    return new Promise((resolve, reject) => {
      ...
      navigator.geolocation.getCurrentPosition(position => { 
          this.userLocation = {lng: position.coords.longitude, lat: position.coords.latitude}
